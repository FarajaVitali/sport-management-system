...
<body>
    <div class="container d-flex min-vh-100 justify-content-center align-items-center py-4">
        <div class="col-12 col-sm-10 col-md-7 col-lg-5">
            <form class="profile-card p-4 p-sm-5 rounded-4" action="{{ route('coach.info.save') }}" method="POST">
                @csrf

                <div class="text-center mb-4">
                    <h2 class="brand-header mb-1">ADD COACH <span class="brand-accent">INFO</span></h2>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="team-select" name="team_id" required disabled>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="phone_number" placeholder="e.g., +255 712 345 678" value="{{ old('phone_number') }}" required>
                </div>
            ...
            fetch(`/api/colleges/${collegeId}/teams`)
                ...
                .then(data => {
                    ...
                    if (data && data.length > 0) {
                        data.forEach(team => {
                            // Note: Adjusted option value to team.id to match backend foreign key storage expectations
